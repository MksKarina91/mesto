...
const popupAdd = document.querySelector('.popup__type_image');
const closeAddButton = popupAdd.querySelector('.popup__close_image');
const formPlaceCreation = popupAdd.querySelector('.popup__form');
const placeName = document.querySelector('.popup__field_name');
